...
const MenPage = () => {
  const { data: menData, isPending } = fetchProductDataHook("men");
  ...
  const products = menData?.productsData || [];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative w-full h-[400px] overflow-hidden mb-8">
        <img
          src="https://images.unsplash.com/photo-1617127365659-c47fa864d8bc?w=1600&h=600&fit=crop"
          alt="Men Collection"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black bg-opacity-20"></div>
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl md:text-6xl font-bold mb-4 tracking-tight">MEN</h1>
